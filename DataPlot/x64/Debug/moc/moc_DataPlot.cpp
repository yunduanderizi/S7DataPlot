...
QT_MOC_LITERAL(1, 9, 9), // "s7Setting"
QT_MOC_LITERAL(2, 19, 0) // ""

    },
    "DataPlot\0s7Setting\0"
};
...
void DataPlot::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<DataPlot *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->s7Setting(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
QT_INIT_METAOBJECT const QMetaObject DataPlot::staticMetaObject = { {
    &QMainWindow::staticMetaObject,
    qt_meta_stringdata_DataPlot.data,
    qt_meta_data_DataPlot,
    qt_static_metacall,
    nullptr,
    nullptr
} };
